...
public class Heater implements HeaterInterface{
    ...
    private final HeaterDataSettings synchronizedData;
     ...
     */
    public Heater(final HeaterDataSettings synchronizedData) {
     ...
     * @param lightRelay
     */
    public Heater(TemperatureSensor overTemp, TemperatureSensor returnTemp, final HeaterDataSettings synchronizedData,
        ...
        if(synchronizedData == null)
            this.synchronizedData = new HeaterDataSettings();
        else
            this.synchronizedData = synchronizedData;
    }
